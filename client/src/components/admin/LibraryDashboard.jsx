            ...
            data.map((item, index) => (
              ...
              >
                <div className="flex flex-col items-center gap-4">
                  <a
                    href={item.pfp}
                    download={`profile_${item.name}.jpg`}
                  ...
                  >
                    <motion.img
                      src={item.pfp}
                      alt="Profile"
                      className="w-20 h-20 rounded-full object-cover border-2 border-light-primary dark:border-dark-primary mb-2 hover:opacity-80 transition-opacity duration-200"
                ...
                <motion.button
                  ...
                  className="cursor-pointer absolute top-4 right-4 text-red-500 hover:text-red-600 transition-colors duration-200"
                >
                  <Trash size={20} />
                </motion.button>
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center">
                <a
                  href={selectedRegistrant.pfp}
                  download={`profile_${selectedRegistrant.name}.jpg`}
                  className="cursor-pointer mb-4"
                >
                  <motion.img
                    src={selectedRegistrant.pfp}
                    alt="Profile"
                    className="w-24 h-24 rounded-full object-cover border-2 border-light-primary dark:border-dark-primary hover:opacity-80 transition-opacity duration-200"
                    whileHover={{ scale: 1.1 }}
                  />
                </a>
              ...
              <div className="space-y-3 font-amiri text-light-text dark:text-dark-text">
                ...
                <p className="flex justify-between"><span className="font-medium">السنة الدراسية:</span> {selectedRegistrant.schoolYear}</p>
                <p className="flex justify-between"><span className="font-medium">رقم الغرفة:</span> {selectedRegistrant.roomNumber}</p>
                <p className="flex justify-between"><span className="font-medium">الولاية:</span> {selectedRegistrant.wilaya}</p>
                ...
                <p className="flex justify-between"><span className="font-medium">الصلاة:</span> {selectedRegistrant.prayerPromise ? 'نعم' : 'لا'}</p>
              </div>
            </motion.div>
          </motion.div>
        )}
